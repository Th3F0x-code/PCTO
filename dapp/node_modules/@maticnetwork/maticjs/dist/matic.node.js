...
/* harmony import */ var _allowance_transaction_option__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_allowance_transaction_option__WEBPACK_IMPORTED_MODULE_19__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _allowance_transaction_option__WEBPACK_IMPORTED_MODULE_19__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _allowance_transaction_option__WEBPACK_IMPORTED_MODULE_19__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
/* harmony import */ var _approve_transaction_option__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_approve_transaction_option__WEBPACK_IMPORTED_MODULE_20__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _approve_transaction_option__WEBPACK_IMPORTED_MODULE_20__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _approve_transaction_option__WEBPACK_IMPORTED_MODULE_20__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ERC721 = /** @class */ (function (_super) {
    ...
    ERC721.prototype.withdrawExitWithMetaData = function (burnTransactionHash, option) {
        var _this = this;
        this.checkForRoot("withdrawExitWithMetaData");
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721TransferWithMetadata, false).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
    ...
    ERC721.prototype.withdrawExitFasterWithMetaData = function (burnTransactionHash, option) {
        var _this = this;
        this.checkForRoot("withdrawExitFasterWithMetaData");
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721TransferWithMetadata, true).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
    ...
    ERC721.prototype.isWithdrawWithMetaDataExited = function (txHash) {
        return this.isWithdrawn(txHash, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721TransferWithMetadata);
    };
