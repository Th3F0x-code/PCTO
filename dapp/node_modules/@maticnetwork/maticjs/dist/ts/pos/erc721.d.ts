...
export declare class ERC721 extends POSToken {
    ...
    withdrawExitWithMetaData(burnTransactionHash: string, option?: ITransactionOption): Promise<import("../interfaces").ITransactionWriteResult>;
    ...
    withdrawExitFasterWithMetaData(burnTransactionHash: string, option?: ITransactionOption): Promise<import("../interfaces").ITransactionWriteResult>;
    isWithdrawExited(txHash: string): Promise<boolean>;
    isWithdrawWithMetaDataExited(txHash: string): Promise<boolean>;
